export const perguntas = [
    {
        enunciado: "Depois de muito tempo dentro da cela, voces ja estao com fome.Mas a porta finalmente se abre e dela sai um homem que nao fala sua lingua. oque voce faz?",
        alternativas: [
            {
                texto: "tenta conversar com ele por gestos",
                afirmacao: [
                    "No primeiro contato ele ri por ver voce tentar falar com ele por gestos, mas comeca a falar em frances",
                    "ao te ver conversando por gestos ele vai embora por te achar bobo falando com sinais. depois de um dia volta falando em frances"
                ],
                proxima: 1,
            },
            {
                texto: "por ter conhecimento em diversas linguas, vai testando todas ate achar alguma que ele fale",
                afirmacao: [
                    "ele te olha surpreso por seu conhecimento, e te responde finalmente em frances",
                    "ele acha engracada sua tentativa de se comunicar, e comeca a falar com voce em frances"
                ],
                proxima: 2,
            },
        ]
    ...
    {
        enunciado: "depois desse primeiro contato ele apresenta a voce o submarino, com as tecnologias mais avancadas existentes e a fartura do lugar, mas ainda um pouco severo, ja que a pouco estavam tentando caca-lo",
        alternativas: [
            {
                texto: "voce presta atencao em tudo procurando possiveis pontos de fuga, mas tenta parecer simpatico para ganhar a confianca do capitao e nao levantar suspeitas",
                afirmacao: [
                    "depois de sair da cela e ser apresentado o submarino, apesar de procurar uma fuga, parece tudo muito bem guardado, nao parece ter esperancas de sair do submarino",
            ...
            {
                texto: "voce presta atencao em tudo, nunca tinha visto tamanha tecnologia, se encanta pelo lugar, passando a gostar tanto do lugar, que nao quer ir mais embora, mas sim aproveitar as maravilhas que o lugar proporciona",
                afirmacao: [
